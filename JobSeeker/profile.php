...
<center>
<div class="dcard"><br/>
 <center><img src="useravater.png" height="90" width="90"/>
</center><br/>
<a href="profile.php"><font color="blue"><b><?php echo $_SESSION['username']; ?></b></font>       <img src="online.png" height="10" width="10"/> </a><br>
" <font color="black"><i><?php echo $row['Quote'];?></i></font> "
<br><a href="update_status.php"><button class="button3">Update Status</button></a>    <a href="update_status.php"><button class="button1">Update Profile</button></a> 
<br/><br/><br/><br/>
<table style="width:95%">
  ...
  <tr>
    <td><b>Name:</b></td>
    <td><font color="black"><i><?php echo $row['Name'];?></i></font></td>
    
  </tr>
  <tr>
    <td><b>Email:</b></td>
    <td><font color="black"><i><?php echo $row['email'];?></i></font></td>
 
  </tr>
  <tr>
<td>  <b>Address:</b>  </td>
<td>  <font color="black"><i><?php echo $row['Address'];?></i></font> </td>
  </tr>
<tr>
<td> <b> Current City: </b></td>
<td> <font color="black"><i><?php echo $row['City'];?></i></font> </td>
</tr>
<tr>
<td><b> Phone Number:</b></td>
<td> <font color="black"><i><?php echo $row['PhoneNumber'];?></i></font> </td>
  </tr>
  <tr>

<td> <b> Qulification: </b></td>
<td>   <font color="black"><i><?php echo $row['Qualification'];?></i></font>   </td>
