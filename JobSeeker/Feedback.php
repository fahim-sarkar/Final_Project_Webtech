 ...
 <div class="container">
   ...
   <div class="forms-container">
        ...
        <div class="signin-signup">
              ...
              <form id="my-form" action="feedback.php" method="post" class="sign-in-form">
                <h2 class="title">JobSeeker Feedback</h2>
                <div class="input-field">
                   <i class="fas fa-user"></i>
            <input type="text" class="form-control" name="name" placeholder="Name" required>
          </div>
              <div class="input-field"> <i class="fas fa-user"></i><input type="email" name="email" class="form-control" placeholder="Email" required></div>
              <div class="input-field"> <i class="fas fa-user"></i><input type="message" name="message" class="form-control" placeholder="Message" required></div>
